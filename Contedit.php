...
?>
    ...
    <?php while ($attachment->next()): ?>
        <li data-cid="<?php $attachment->cid(); ?>" data-title="<?php $attachment->title(); ?>" data-url="<?php echo $attachment->attachment->url; ?>" data-image="<?php echo $attachment->attachment->isImage ? 1 : 0; ?>"><input type="hidden" name="attachment[]" value="<?php $attachment->cid(); ?>" />
            <a class="insert" title="<?php echo ('点击插入文件'); ?>" href="###">
            ...
            <div class="info">
                ...
                <!--<a class="file" target="_blank" href="<?php $options->adminUrl('media.php?cid=' . $attachment->cid); ?>" title="<?php echo ('编辑'); ?>"><i class="icon iconfont icon-icon-test10"></i></a>-->
                <a href="###" class="delete" title="<?php echo ('删除'); ?>"><i class="ri-close-line ri-lg"></i></a>
                <a href="###" class="fimg" title="<?php echo ('封面'); ?>"><i class="ri-image-fill ri-lg"></i></a>
            </div>
        </li>
    <?php endwhile; ?>
    </ul>
     ...
     function fileUploadComplete (id, url, data) {
        var li = $('#' + id).removeClass('loading').data('cid', data.cid)
            ...
            .html('<input type="hidden" name="attachment[]" value="' + data.cid + '" />'
                ...
                + ' <a class="delete" href="###" title="<?php echo ('删除'); ?>"><i class="icon iconfont icon-shanchu"></i></a><a href="###" class="fimg" title="<?php echo ('封面'); ?>"><i class="icon iconfont icon-tupian"></i></a></div>')
